...
if _int == 0:
    ...
    print('Negative')
if _int % 2 == 0:  # this line of code tests of remainder of the number when divided by two
...
# 2
height_1 = float(input('Please enter the height of the first rectangle: '))
height_2 = float(input('Please enter the height of the second rectangle: '))
...
if total_score >= 50 and test_results >= 25:
    if total_score >= 80:
        print('Passed with Distinction grade.')
...
# 13
__weight = int(input('Please enter the weight of your packages: '))
if _weight <= 2 and _wieght > 0:
    charge = _wieght*1.5
    print('The total shipping charges will be', charge)
elif _weight > 2 and _wieght <= 6:
    charge = _wieght*3
    print('The total shipping charges will be', charge)
elif _weight > 6 and _wieght <= 10:
    charge = _wieght*4
    print('The total shipping charges will be', charge)
elif _weight > 10:
    charge = _wieght*4.75
...
# 14 
height_3 = float(input('Please enter your height: '))
weight_2 = float(input('Please enter your weight: '))
BMI = (weight_2*703)/(height_3**2)
if BMI < 18.5 and BMI > 0:
    print('You are underweight, hit the GYM. ')
elif BMI >= 18.5 and BMI < 25:
    print('You are in good shape.')
elif BMI >= 25:
    print('You are over weight, hit the GYM. ')
else:
    print('Invalid Value.')
