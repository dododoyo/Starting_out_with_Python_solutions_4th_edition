...
# ------- >>> Answer to Algorithm Short Answer Questions < ------- #
...
# 1 
# TIP -> the input function always recevies and stores data as a string.
age_number = input('Please enter your age here : ') # Recieves age of the user
...
# 8
# according to precedence of the operations b*c will be excuted first and it's result
...
# 11
number = 1234567.456
number = format(number, ',.1f')    # This code reassignes the value of  the variable number
print(number)
...
# size that is more than diameter of the circle(i,e 160 pixels) or it is goung to be the
