...
# 5
speed = 70
distance_1 = 70*6     #This is the distance travlled in 6 hours
distance_2 = 70*10    #This is the distance travlled in 10 hours
distance_3 = 70*15    #This is the distance travlled in 15 hours
...
E = int(input('Please enter amoint of space used by and end-post assembly in feet: '))
S = int(input('Please enter the amoun of space between vines: '))
V = (R-(2*E))/S
